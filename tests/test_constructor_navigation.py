...
from locators import (
    ...
    SECTION_SAUCES,
    SECTION_FILLINGS,
    ACTIVE_TAB_NAME # ИСПРАВЛЕНО: Добавлен локатор для проверки текста активного таба
)
...
class TestConstructorNavigation:
    ...
    # ИСПРАВЛЕНО: Убран login, так как для конструктора авторизация не нужна
    def test_constructor_tab_navigation(self, driver, wait, tab_locator, section_name):
        ...
        # ИСПРАВЛЕНО: Проверка видимости контента таба через текст активной вкладки
